...
public class FlutterSegmentOptions {
    ...
    public  FlutterSegmentOptions(String writeKey, Boolean trackApplicationLifecycleEvents, Boolean amplitudeIntegrationEnabled, Boolean firebaseIntegrationEnabled, Boolean debug) {
    ...
    static FlutterSegmentOptions create(Bundle bundle) {
        ...
        return new FlutterSegmentOptions(writeKey, trackApplicationLifecycleEvents, isAmplitudeIntegrationEnabled, isFirebaseIntegrationEnabled, debug);
    }
